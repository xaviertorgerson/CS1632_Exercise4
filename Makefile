...
COMPILE_TARGETS=$(SRC_DIR)Cat.java $(TEST_DIR)CatTest.java $(SRC_DIR)Customer.java $(TEST_DIR)CustomerTest.java $(SRC_DIR)RentACat.java

# Testing targets.
# Their directory will be on the Class Path.
TEST_TARGETS=CatTest CustomerTest RentACat
